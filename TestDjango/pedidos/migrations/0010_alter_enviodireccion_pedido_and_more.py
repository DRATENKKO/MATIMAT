...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('pedidos', '0009_alter_enviodireccion_pedido_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='pedido',
            field=models.ForeignKey(db_constraint=False, default=True, on_delete=django.db.models.deletion.CASCADE, to='pedidos.pedido'),
        ),
        migrations.AlterField(
            model_name='enviodireccion',
            name='user',
